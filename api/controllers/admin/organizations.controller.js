  ...
  return new Promise((resolve, reject) => {
    ...
    if (req.query.name || req.query.search) {
      filter.$or = [
        ...
        { 'billingInfo.companyName': { $regex: `.*${req.query.name || req.query.search}.*`, $options: 'i' } },
        { 'billingInfo.firstName': { $regex: `.*${req.query.name || req.query.search}.*`, $options: 'i' } },
        { 'billingInfo.lastName': { $regex: `.*${req.query.name || req.query.search}.*`, $options: 'i' } },
      ]
